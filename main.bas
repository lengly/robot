...
now:	
	SPEED 5
	'踢腿 准备
	MOVE G6A, 110,  76, 145,  93,  98,  
	MOVE G6D, 103,  76, 145,  93,  96,  
	MOVE G6B, 100,  30,  80,  ,  ,  
	MOVE G6C, 100,  30,  80,  ,  ,  
	WAIT
	'踢腿 抬右腿
	MOVE G6A, 113,  53, 174,  91, 110,  
	MOVE G6D,  99,  80,  36, 159,  84,  
	MOVE G6B, 111, 184,  26,  ,  ,  
	MOVE G6C, 104,  10, 175,  ,  ,  
	WAIT
	DELAY 300
	'踢腿 放右腿
	MOVE G6A, 113,  53, 174,  91, 110,  
	MOVE G6D, 100,  80, 110, 117,  84,  
	MOVE G6B, 106, 106,  13,  ,  ,  
	MOVE G6C, 107,  86,  10,  ,  ,  
	WAIT
	DELAY 300
	'踢腿 踢右腿
	MOVE G6A, 113,  53, 174,  82, 110,  
